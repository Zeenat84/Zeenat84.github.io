---
title: "Class 13 Notes and Exercises"
author: ZN
...
Spread columns to convert a long table to wide
Gather columns to convert a wide table to long
Separate a column
Clean the who data (https://www.who.int/tb/country/data/download/en/)
...
library(tidyverse)
table1 %>% 
  gather(key = "type", value = "count", cases, population) #Gathering cases and pop into a single dataset and creating an untidy tibble
```
